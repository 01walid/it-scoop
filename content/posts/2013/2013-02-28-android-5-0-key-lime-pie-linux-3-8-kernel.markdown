...
[![google-android-linux3-8-kernel](http://www.it-scoop.com/wp-content/uploads/2013/02/google-android-linux3-8-kernel.png)
](http://www.it-scoop.com/wp-content/uploads/2013/02/google-android-linux3-8-kernel.png)
...
تشير بعض التكهنات أن هذا الاقتراح، يصُبُ في صالح الإصدارة القادمة من نظام Android 5.0 والتي ستحمل اسم [Key Lime Pie.](http://en.wikipedia.org/wiki/Key_lime_pie)
	  ...
	  * ترى هل تشفع ميزات Android وتطوره لتصرفات Google الغريبة فيه، [كتنصيب البرامج عن بعد ومن دون إذن](http://www.it-scoop.com/2013/02/android-google-settings/)؟
